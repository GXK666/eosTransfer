...
func (*CheckAccountRequest) Descriptor() ([]byte, []int) { return fileDescriptorGeneral, []int{10} }
...
func (*CheckAccountResponse) Descriptor() ([]byte, []int) { return fileDescriptorGeneral, []int{11} }
...
func (c *serviceClient) CheckAccountExist(ctx context.Context, in *CheckAccountRequest, opts ...grpc.CallOption) (*CheckAccountResponse, error) {
	...
	err := grpc.Invoke(ctx, "/general.Service/CheckAccountExist", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptorGeneral = []byte{
	...
	,
}
